...
with open(f'{old_tileset_name}/tile_config.json') as old_tile_config_json_file:
...
with open(f'{new_tileset_name}/tile_config.json', 'w') as tile_config_json:
    json.dump(
        ntc, tile_config_json,
        sort_keys=True, indent=2, separators=(',', ': '))

#TODO: replace tiles.png with first filename from json
with open(f'{new_tileset_name}/tileset.txt', 'w') as new_tileset_txt_file:
